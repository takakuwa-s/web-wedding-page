          ...
          <div className="form-input-field">
            <section>
              ...
              <div className="form-input-textfield">
                <input type="text" maxLength={100} name="name" placeholder="山田花子" />
              </div>
            </section>
            <section>
              <h2>ふりがな</h2>
              <div className="form-input-textfield">
                <input type="text" maxLength={100} name="hurigana" placeholder="やまだはなこ" />
              </div>
            </section>
            <section>
              <h2>出欠</h2>
              <div className="form-input-attendancefield">
                <div className="form-input-attendancefield__item">
                  <input type="radio" name="attendance" id="attendance_yes"/>
                  <label htmlFor="attendance_yes">ご出席</label>
                </div>
                <div className="form-input-attendancefield__item">
                  <input type="radio" name="attendance" id="attendance_no"/>
                  <label htmlFor="attendance_no">ご欠席</label>
                </div>
              </div>
            </section>
            <section>
              ...
              <div className="form-input-radiofield">
                <div className="form-input-radiofield__item">
                  <input type="radio" name="relation" id="relation_groom"/>
                  <label htmlFor="relation_groom">新郎側</label>
                </div>
                <div className="form-input-radiofield__item">
                  <input type="radio" name="relation" id="relation_bride"/>
                  <label htmlFor="relation_bride">新婦側</label>
                </div>
                <div className="form-input-radiofield__item">
                  <input type="radio" name="relation" id="relation_common"/>
                  <label htmlFor="relation_common">共通</label>
                </div>
              </div>
            </section>
            <section>
              ...
              <div className="form-input-postfield">
                <div className="form-input-postfield__text">
                  <input type="text" maxLength={100} name="post-code" placeholder="1234567" className="js-adress-set__post-code"/>
                </div>
                <div className="form-input-postfield__button"><button type="button" className="js-adress-set">住所検索</button></div>
              </div>
            </section>
            <section>
              <h2>住所</h2>
              <div className="form-input-textfield">
                <input type="text" className="js-adress-set__target" maxLength={100} name="address" placeholder="東京都渋谷区0-1-23"/>
              </div>
            </section>
            <section>
              <h2>メールアドレス</h2>
              <div className="form-input-textfield">
                <input type="text" maxLength={100} name="mail" placeholder="sample@sample.com"/>
              </div>
            </section>
            <section>
              <h2>アレルギーや苦手な食材</h2>
              <div className="form-input-textfield">
                <input type="text" maxLength={100} name="food" placeholder="食材名、食材名"/>
              </div>
            </section>
            <section>
              <h2>お連れ様追加</h2>
              <section className="form-add">
                <h3>１人目</h3>
                <div className="form-input-textfield">
                  <input type="text" maxLength={100} name="add01-name" placeholder="お連れ様氏名"/>
                </div>
                <div className="form-input-textfield">
                  <input type="text" maxLength={100} name="add01-food" placeholder="お連れ様のアレルギーや苦手な食材"/>
                </div>
              </section>
              <section className="form-add">
                <h3>２人目</h3>
                <div className="form-input-textfield">
                  <input type="text" maxLength={100} name="add02-name" placeholder="お連れ様氏名"/>
                </div>
                <div className="form-input-textfield">
                  <input type="text" maxLength={100} name="add02-food" placeholder="お連れ様のアレルギーや苦手な食材"/>
                </div>
              </section>
            </section>
            <section>
              <h2>メッセージ</h2>
              <div className="form-input-textfield">
                <textarea maxLength={100} name="メッセージ"></textarea>
              </div>
            </section>
          </div>
